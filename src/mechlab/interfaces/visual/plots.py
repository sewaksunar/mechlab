...
from mechlab.domain.entities import DistributedLoad, PointLoad
...
from mechlab.domain.entities import PointLoad, DistributedLoad, SupportType
from mechlab.domain.strength.beam import Beam
...
def plot_fbd_beam(beam, save_path: str | None = None, show: bool = False):
    ...
    # ------------------------------------------------------------------
    force_mags = (
        [abs(l.magnitude) / 1000 for l in point_loads]
        + [abs(l.intensity) / 1000 for l in dist_loads]
